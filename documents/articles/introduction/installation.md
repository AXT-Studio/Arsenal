...
- 基本的に、`https://esm.sh/jsr/@ayaexptech/arsenal@<version>`の形式でアクセスします。
...
```js
// Adhoc import
import { <exported_member> } from "https://esm.sh/jsr/@ayaexptech/arsenal@<version>?target=es2024";
```
...
```js
// Adhoc import
import { <exported_member> } from "jsr:@ayaexptech/arsenal@<version>";
```
...
```
```js
import { <exported_member> } from "@ayaexptech/arsenal";
```
